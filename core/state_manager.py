...
BASE_GAME_STATE = {
    ...
    "map_piece_2_collected": False,
    "map_piece_3_collected": False,
...
class StateManager:
    ...
    def load_for_level2(self):
        ...
        # Persist map pieces when present in older/newer saves.
        self.game_state["map_piece_1_collected"] = save_data.get(
            "map_piece_1_collected", save_data.get("map_piece_collected", False)
        )
        self.game_state["map_piece_2_collected"] = save_data.get("map_piece_2_collected", False)
        self.game_state["map_piece_3_collected"] = save_data.get("map_piece_3_collected", False)
        self.game_state["strategy_executed"] = save_data.get("strategy_executed", False)
