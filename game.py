...
from scenes.level3_vidisha_scene import Level3VidishaScene
...
class Game:
    def __init__(self):
        ...
        self.scene_factories = {
            "level3_vidisha": lambda: Level3VidishaScene(self, self.state_manager),
            "level_complete": lambda: LevelCompleteScene(self, self.state_manager),
        }
        self.load_scene("level3_vidisha")
